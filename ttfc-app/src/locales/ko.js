...
module.exports = {
    ...
    'win.statusDisplay': '멤버 목록 표시',
    'win.statusDisplayHint': '프로필 아래 한 줄에 무엇을 보일지 (사이트별)',
    'win.sdSeries': '작품명',
    'win.sdEpisode': '에피소드',
    'win.sdAppName': '앱 이름',
    ...
    'win.activityType': '활동 종류',
    'win.activityTypeHint': '디스코드가 카드를 그리는 방식이 달라집니다',
    'win.actWatching': '시청 중 (진행 바)',
    'win.actListening': '듣는 중 (목록에도 표시)',
    'win.actPlaying': '플레이 중 (남은 시간)',
    'win.timeMode': '시간 표시',
    'win.timeProgress': '경과 + 남은 시간',
    'win.timeRemaining': '남은 시간만',
    'win.timeNone': '표시 안 함',
    'win.idleTimeout': '자동 해제',
    'win.idleTimeoutHint': '브라우저가 꺼진 뒤 프로필에서 내릴 때까지',
    'win.idleNever': '안 사라짐',
    'win.idleMin': '{n}분 뒤',
    'win.idleHour': '{n}시간 뒤',
    'win.language': '언어',
